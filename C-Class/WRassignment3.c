...
for(;;)
{
    ...
    if(i == 0)
    {
        printf("Your array list has been created!\n");
        i++;
    }

    do{
        //Lists all the options to the user
        printf("\nWhat would you like to do with the array list?\n\n");
    ...
    switch(option)
    {
        ...
        system("cls");
            ...
            if(size < MAX_Size)
            {
               appendList(&arrayList, &size, apndNum);
            }
            else
            {
        ...
        case insert:
            ...
            //checks for out f bounds index and prints an error
            system("cls");
        ...
        case remov3:
            ...
            {
                system("cls");
                removeatIndex(&arrayList, &size, indxNum);
